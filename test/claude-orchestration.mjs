...
const result = spawnSync(
  ...
  ],
  {
    ...
    env: {
      ...
      CODEX_SUBAGENTS_SESSION_STATE_FILE: path.join(os.tmpdir(), `codex-subagents-orchestration-${process.pid}.sessions.json`),
    },
